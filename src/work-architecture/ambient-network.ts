...
import type { ArchitectureAmbientHub, ArchitectureTone } from './types.ts';
...
function pickTone(index: number): ArchitectureTone {
...
function samplePosition(
  ...
  hubs: readonly ArchitectureAmbientHub[],
